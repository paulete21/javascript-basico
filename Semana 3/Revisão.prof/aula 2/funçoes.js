/*Questão 1
var raio = prompt("digite o valor")
...
maior =((ab+c)+Math.abs(ab-c))/2  //vai sempre escolher o maior numero
...
if(idade>=16 && idade<69){
    ...
    switch(tipoSanguineo){
        ...
        case 'o':console.log('doador: a,b,o,ab')
                 ...
                 break;
        default: console.log("tipo sanguineo inválido")
...
if(x % 1 != 0 && !isNaN(x % 1)) // true se somente se x é decimal
    console.log("é decimal")
else
    console.log("não é decimal")


// somatorio: 1+ 1/2 + 1/3 + 1/4 ... 1/100
...
switch(op){
    case 1: var valorRecebido = prompt('digite o valor recebido')
...
var matriz = [[1,2,3,4],   //principal 1+7+11+16 = 34
              [5,6,7,8],
              [9,10,11,12],   //secundaria 4+7+10+13 = 34
              [13,14,15,16]]
...
while(flag){
    ...
    switch(op){
        ...
        case 2: var saque = Number(prompt('digite o valor do saque'))
                ...
                break;
        case 3: var depósito = Number(prompt('digite o valor do depósito'))
                saldo+=depósito
                break;
        case 4: flag= false; console.log('operacao finalizada'); break;
...
var numero = Number(prompt('digite um numero entre 0 e 999'))
